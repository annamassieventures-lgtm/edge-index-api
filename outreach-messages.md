...
## MESSAGE 1 — Introduction + Founding Beta Offer
**SEND: DAY 1 | PURPOSE: INTRIGUE + MAKE THE OFFER**

---

Hey [NAME],

Came across [COMMUNITY NAME] — seriously impressive what you've built. [X]K members engaged around trading signals is no small thing.
...
The B2B model: you offer it to your community as a premium add-on. Your members get better execution. You get a new revenue stream. I handle all delivery via bot.

I'm opening 5 founding operator spots at $500/month for the first 3 months (standard pricing is $2,500–$12,000/month depending on community size). I'd like to offer you one of those spots.
...
## MESSAGE 2 — Follow-Up
**SEND: 3 DAYS AFTER MESSAGE 1 | PURPOSE: RE-ENGAGE + REFRAME VALUE**
...
## MESSAGE 3 — Close
**SEND: 5 DAYS AFTER MESSAGE 2 | PURPOSE: CREATE URGENCY + FINAL OFFER**
...
I'm closing the founding beta offer at the end of this week. After that, pricing moves to the standard tier ($2,500/month+). I've got one spot left at the $500/month rate, and based on the size and engagement of [COMMUNITY NAME], I'd rather it go to you than anyone else.
...
## PERSONALISED MESSAGE 1s — PRIORITY 5 TARGETS
...
### 4. Jacob's Crypto Clan (Discord) — 44.5K
...
### 5. Rand Trading Group (Discord + YouTube) — 38.8K
...
| Target | Handle | Platform | M1 Sent | M2 Sent | M3 Sent | Response | Outcome |
|--------|--------|----------|---------|---------|---------|----------|---------|
| Wolf of Trading | @WolfofTradingAdmin | Telegram | — | — | — | — | — |
| Bitcoin Bullets | @joe1322 | Telegram | — | — | — | — | — |
| Fat Pig Signals | @dad10 | Telegram | — | — | — | — | — |
| Jacob's Crypto Clan | Discord DM | Discord | — | — | — | — | — |
| Rand Trading Group | Discord DM | Discord | — | — | — | — | — |

## TIMING
- **Best days:** Tuesday, Wednesday, Thursday
- **Telegram operators:** 8:00–10:00am their local time
- **Discord/YouTube operators:** 6:30–8:30pm their local time
- **Avoid:** Monday mornings, Friday afternoons, major volatility events
